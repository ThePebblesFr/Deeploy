...
from testUtils.testRunnerDeeploy import TestRunner, TestRunnerArgumentParser
...
if __name__ == "__main__":
    ...
    testRunner.cmake_args += f"-DENABLE_MULTIDEEPLOY_TEST=OFF -DENABLE_DYNMULTIDEEPLOY_TEST=OFF -D NUM_CORES={args.cores}"
