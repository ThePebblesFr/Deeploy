...
class TestRunnerArgumentParser(argparse.ArgumentParser):
    ...
    def __init__(self, tiling_arguments: bool, description = None):
        ...
        self.add_argument('-t',
                          ...
                          required = True,
                          help = 'Set the regression test\n')
        self.add_argument('--test-gen',
                          metavar = '<dir>',
                          dest = 'test_gen_dir',
                          type = str,
                          required = True,
                          help = 'Set the test generation directory\n')
        self.add_argument('-v', action = 'count', dest = 'verbose', default = 0, help = 'Increase verbosity level\n')
        self.add_argument('-D',
                          dest = 'cmake',
                          action = 'extend',
...
class TestRunner():
    ...
    def __init__(self,
        ...
        self._dir_gen = os.path.join("/app/Deeploy/DynMultiDeeployTest/", self._dir_gen_root, self._args.test_gen_dir)
    ...
    def profile_tiling_to_json(self, result: str):
        try:
    ...
    def generate_test(self):
        if self._tiling is True:
            generation_script = "../DeeployTest/testMVP.py"
        else:
            generation_script = "../DeeployTest/generateNetwork.py"
    ...
    def configure_cmake_project(self):
        ...
        print(f"[TestRunner] Cmake Command: {command}")
    ...
    def build_binary(self):
        ...
        print(f"[TestRunner] Building Command: {command}")
    ...
    def run_simulation(self, out_file = 'out.txt'):
        ...
        print(f"[TestRunner] Simulation Command: {command}")
        ...
        if self._args.profileTiling and self._args.profileToJSON:
            self.profile_tiling_to_json(result)
