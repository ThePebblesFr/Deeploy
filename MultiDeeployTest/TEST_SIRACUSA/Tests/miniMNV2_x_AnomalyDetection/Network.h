...
extern int8_t *miniMNV2_MEMORYARENA_L1; // L2_init_template
static const uint32_t miniMNV2_MEMORYARENA_L1_len = 7712;
extern int8_t *miniMNV2_MEMORYARENA_L2; // L2_init_template
static const uint32_t miniMNV2_MEMORYARENA_L2_len = 4096;
extern uint8_t *miniMNV2_input_0; // L2_init_template
static const uint32_t miniMNV2_input_0_len = 768;
extern int8_t *miniMNV2_output_0; // L2_init_template
static const uint32_t miniMNV2_output_0_len = 10;
static const uint32_t miniMNV2_num_inputs = 1;
static const uint32_t miniMNV2_num_outputs = 1;
extern void *miniMNV2_inputs[1];
extern void *miniMNV2_outputs[1];
static const uint32_t miniMNV2_inputs_bytes[1] = {768};
static const uint32_t miniMNV2_outputs_bytes[1] = {10};
