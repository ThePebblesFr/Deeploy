...
extern int8_t *SimpleMLP_MEMORYARENA_L1; // L2_init_template
static const uint32_t SimpleMLP_MEMORYARENA_L1_len = 26784;
extern int8_t *SimpleMLP_MEMORYARENA_L2; // L2_init_template
static const uint32_t SimpleMLP_MEMORYARENA_L2_len = 1824;
extern float32_t *SimpleMLP_input_0; // L2_init_template
static const uint32_t SimpleMLP_input_0_len = 392;
extern float32_t *SimpleMLP_output_0; // L2_init_template
static const uint32_t SimpleMLP_output_0_len = 10;
static const uint32_t SimpleMLP_num_inputs = 1;
static const uint32_t SimpleMLP_num_outputs = 1;
extern void *SimpleMLP_inputs[1];
extern void *SimpleMLP_outputs[1];
static const uint32_t SimpleMLP_inputs_bytes[1] = {1568};
static const uint32_t SimpleMLP_outputs_bytes[1] = {40};
#endif
