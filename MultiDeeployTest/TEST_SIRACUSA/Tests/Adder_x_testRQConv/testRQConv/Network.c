...
int8_t *testRQConv_MEMORYARENA_L1; // L2_init_template
int8_t *testRQConv_MEMORYARENA_L2; // L2_init_template
int8_t *testRQConv_input_0;        // L2_init_template
int8_t *testRQConv_output_0;       // L2_init_template
...
static void testRQConv__MERGE_CONVRQ_PASS_0_input_0_transpose_closure(void *testRQConv__MERGE_CONVRQ_PASS_0_input_0_transpose_closure_args) {
  ...
  // CLOSURE FUNCTION CALL
  int8_t *testRQConv_TILING_CODEGEN_L1__MERGE_CONVRQ_PASS_0_input_0_transpose_data_in_ref = (int8_t *)((char *)testRQConv_MEMORYARENA_L1 + 0); // ARENA ALLOCATE
  int8_t *testRQConv_TILING_CODEGEN_L1__MERGE_CONVRQ_PASS_0_input_0_transpose_data_out_ref =
      (int8_t *)((char *)testRQConv_MEMORYARENA_L1 + 4096); // ARENA ALLOCATE
...
static void testRQConv__MERGE_CONVRQ_PASS_0_closure(void *testRQConv__MERGE_CONVRQ_PASS_0_closure_args) {
  ...
  // CLOSURE FUNCTION CALL
  int8_t *testRQConv_TILING_CODEGEN_L1__MERGE_CONVRQ_PASS_0_data_in_ref = (int8_t *)((char *)testRQConv_MEMORYARENA_L1 + 6372); // ARENA ALLOCATE
  int8_t *testRQConv_TILING_CODEGEN_L1__MERGE_CONVRQ_PASS_0_weight_ref = (int8_t *)((char *)testRQConv_MEMORYARENA_L1 + 12516); // ARENA ALLOCATE
  int32_t *testRQConv_TILING_CODEGEN_L1__MERGE_CONVRQ_PASS_0_mul_ref = (int32_t *)((char *)testRQConv_MEMORYARENA_L1 + 13028);  // ARENA ALLOCATE
  int32_t *testRQConv_TILING_CODEGEN_L1__MERGE_CONVRQ_PASS_0_add_ref = (int32_t *)((char *)testRQConv_MEMORYARENA_L1 + 13044);  // ARENA ALLOCATE
  int8_t *testRQConv_TILING_CODEGEN_L1__MERGE_CONVRQ_PASS_0_data_out_ref = (int8_t *)((char *)testRQConv_MEMORYARENA_L1 + 0);   // ARENA ALLOCATE
  ...
  void *testRQConv__MERGE_CONVRQ_PASS_0_buffer = (void *)((char *)testRQConv_MEMORYARENA_L1 + 10468); // ARENA ALLOCATE
...
static void testRQConv__MERGE_CONVRQ_PASS_0_output_0_pre_transpose_closure(void *testRQConv__MERGE_CONVRQ_PASS_0_output_0_pre_transpose_closure_args) {
  ...
  // CLOSURE FUNCTION CALL
  int8_t *testRQConv_TILING_CODEGEN_L1__MERGE_CONVRQ_PASS_0_output_0_pre_transpose_data_in_ref =
      (int8_t *)((char *)testRQConv_MEMORYARENA_L1 + 6372); // ARENA ALLOCATE
  int8_t *testRQConv_TILING_CODEGEN_L1__MERGE_CONVRQ_PASS_0_output_0_pre_transpose_data_out_ref =
      (int8_t *)((char *)testRQConv_MEMORYARENA_L1 + 0); // ARENA ALLOCATE
...
void RunNetwork() {
  int8_t *testRQConv__MERGE_CONVRQ_PASS_0_input_0_transposed;      // L2_init_template
  int8_t *testRQConv__MERGE_CONVRQ_PASS_0_output_0_pre_transposed; // L2_init_template
  void *testRQConv__MERGE_CONVRQ_PASS_0_buffer;                    // L2_init_template
  ...
  // RUNNETRWORK LAYER testRQConv__MERGE_CONVRQ_PASS_0_input_0_transpose CALL START
  ...
  // RUNNETRWORK LAYER testRQConv__MERGE_CONVRQ_PASS_0_input_0_transpose CALL END

  // RUNNETRWORK LAYER testRQConv__MERGE_CONVRQ_PASS_0 CALL START
  ...
  // RUNNETRWORK LAYER testRQConv__MERGE_CONVRQ_PASS_0 CALL END

  // RUNNETRWORK LAYER testRQConv__MERGE_CONVRQ_PASS_0_output_0_pre_transpose CALL START
  ...
  // RUNNETRWORK LAYER testRQConv__MERGE_CONVRQ_PASS_0_output_0_pre_transpose CALL END
}
