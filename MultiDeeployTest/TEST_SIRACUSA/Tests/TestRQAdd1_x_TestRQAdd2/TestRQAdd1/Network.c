...
} TestRQAdd1__MERGE_ADDRQ_PASS_0_tiling_closure_args_t;
// LAYER FUNCTION STRUCT DEFINITION, END

// LAYER FUNCTION CLOSURE, START
static void TestRQAdd1__MERGE_ADDRQ_PASS_0_tiling_closure(void *TestRQAdd1__MERGE_ADDRQ_PASS_0_tiling_closure_args) {
  // CLOSURE ARG CAST
  TestRQAdd1__MERGE_ADDRQ_PASS_0_tiling_closure_args_t *args =
      (TestRQAdd1__MERGE_ADDRQ_PASS_0_tiling_closure_args_t *)TestRQAdd1__MERGE_ADDRQ_PASS_0_tiling_closure_args;
  ...
  pulp_nn_add_i8_i8_i8(TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_data_in_1_ref, TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_data_in_2_ref,
                       ...
                       *TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_size_ref, 1, 1, NUM_CORES);
...
typedef struct {
  ...
  int8_t *TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_data_in_2_ref;
  int8_t *TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_data_out_ref;
} TestRQAdd1__MERGE_ADDRQ_PASS_0_cluster_fork_args_t;
// LAYER FUNCTION STRUCT DEFINITION, END

// LAYER FUNCTION CLOSURE, START
static void TestRQAdd1__MERGE_ADDRQ_PASS_0_cluster_fork(void *TestRQAdd1__MERGE_ADDRQ_PASS_0_cluster_fork_args) {
  // CLOSURE ARG CAST
  TestRQAdd1__MERGE_ADDRQ_PASS_0_cluster_fork_args_t *args =
      (TestRQAdd1__MERGE_ADDRQ_PASS_0_cluster_fork_args_t *)TestRQAdd1__MERGE_ADDRQ_PASS_0_cluster_fork_args;
  uint16_t *TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_size_ref = args->TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_size_ref;
  int8_t *TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_data_in_1_ref = args->TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_data_in_1_ref;
  int8_t *TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_data_in_2_ref = args->TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_data_in_2_ref;
  int8_t *TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_data_out_ref = args->TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_data_out_ref;
  ...
  // CLOSURE FUNCTION CALL
  TestRQAdd1__MERGE_ADDRQ_PASS_0_tiling_closure_args_t TestRQAdd1_TestRQAdd1__MERGE_ADDRQ_PASS_0_tiling_closure_args =
      (TestRQAdd1__MERGE_ADDRQ_PASS_0_tiling_closure_args_t){
  ...
  // TestRQAdd1__MERGE_ADDRQ_PASS_0_tiling_closure CLOSURE CALL
  TestRQAdd1__MERGE_ADDRQ_PASS_0_tiling_closure(&TestRQAdd1_TestRQAdd1__MERGE_ADDRQ_PASS_0_tiling_closure_args);
...
} TestRQAdd1__MERGE_ADDRQ_PASS_0_closure_args_t;
// LAYER FUNCTION STRUCT DEFINITION, END

// LAYER FUNCTION CLOSURE, START
static void TestRQAdd1__MERGE_ADDRQ_PASS_0_closure(void *TestRQAdd1__MERGE_ADDRQ_PASS_0_closure_args) {
  // CLOSURE ARG CAST
  TestRQAdd1__MERGE_ADDRQ_PASS_0_closure_args_t *args = (TestRQAdd1__MERGE_ADDRQ_PASS_0_closure_args_t *)TestRQAdd1__MERGE_ADDRQ_PASS_0_closure_args;
  ...
  void *TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_input_0_ref = (void *)((char *)TestRQAdd1_input_0 + 0);
  void *TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_input_1_ref = (void *)((char *)TestRQAdd1_input_1 + 0);
  void *TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_output_0_ref = (void *)((char *)TestRQAdd1_output_0 + 0);
  ...
  // TILING LOOP
  for (int TILING_I = TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_numTiles[*TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_tileIdxPtr];
       TILING_I < TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_numTiles[(*TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_tileIdxPtr) + 1]; TILING_I++) {
    ...
    *TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_size_ref = TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_size[TILING_I];
    ...
    TestRQAdd1__MERGE_ADDRQ_PASS_0_cluster_fork_args_t TestRQAdd1_TestRQAdd1__MERGE_ADDRQ_PASS_0_cluster_fork_args =
        (TestRQAdd1__MERGE_ADDRQ_PASS_0_cluster_fork_args_t){
            .TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_size_ref = TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_size_ref,
            .TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_data_in_1_ref = TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_data_in_1_ref,
            .TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_data_in_2_ref = TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_data_in_2_ref,
    ...
    pi_cl_team_fork(NUM_CORES, (void *)TestRQAdd1__MERGE_ADDRQ_PASS_0_cluster_fork, &TestRQAdd1_TestRQAdd1__MERGE_ADDRQ_PASS_0_cluster_fork_args);
  ...
  *TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_tileIdxPtr += 1;

  // Deinitialize DMA futures

  StopTimer();
  for (int PROFILING_I = ((*TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_tileIdxPtr > 0)
                              ? TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_numTiles[(*TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_tileIdxPtr - 1)]
                              : 0);
       PROFILING_I < TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_numTiles[*TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_tileIdxPtr]; PROFILING_I++) {
...
typedef struct {
  uint8_t *TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_tileIdxPtr;
} TestRQAdd1__MERGE_ADDRQ_PASS_0_closure_L3_args_t;
// LAYER FUNCTION STRUCT DEFINITION, END

// LAYER FUNCTION CLOSURE, START
static void TestRQAdd1__MERGE_ADDRQ_PASS_0_closure_L3(void *TestRQAdd1__MERGE_ADDRQ_PASS_0_closure_L3_args) {
  // CLOSURE ARG CAST
  TestRQAdd1__MERGE_ADDRQ_PASS_0_closure_L3_args_t *args = (TestRQAdd1__MERGE_ADDRQ_PASS_0_closure_L3_args_t *)TestRQAdd1__MERGE_ADDRQ_PASS_0_closure_L3_args;
  uint8_t *TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_tileIdxPtr = args->TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_tileIdxPtr;

  // CLOSURE FUNCTION CALL
  TestRQAdd1__MERGE_ADDRQ_PASS_0_closure_args_t TestRQAdd1_TestRQAdd1__MERGE_ADDRQ_PASS_0_closure_args = (TestRQAdd1__MERGE_ADDRQ_PASS_0_closure_args_t){
      .TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_tileIdxPtr = TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_tileIdxPtr};

  // TestRQAdd1__MERGE_ADDRQ_PASS_0_closure CLOSURE CALL
  TestRQAdd1__MERGE_ADDRQ_PASS_0_closure(&TestRQAdd1_TestRQAdd1__MERGE_ADDRQ_PASS_0_closure_args);
...
void RunNetwork() {
  ...
  // RUNNETRWORK LAYER TestRQAdd1__MERGE_ADDRQ_PASS_0 CALL START

  TestRQAdd1__MERGE_ADDRQ_PASS_0_closure_L3_args_t TestRQAdd1_TestRQAdd1__MERGE_ADDRQ_PASS_0_closure_L3_args =
      (TestRQAdd1__MERGE_ADDRQ_PASS_0_closure_L3_args_t){.TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_tileIdxPtr =
                                                             TestRQAdd1_TILING_CODEGEN_L1__MERGE_ADDRQ_PASS_0_tileIdxPtr};

  // TestRQAdd1__MERGE_ADDRQ_PASS_0_closure_L3 CLOSURE CALL
  TestRQAdd1__MERGE_ADDRQ_PASS_0_closure_L3(&TestRQAdd1_TestRQAdd1__MERGE_ADDRQ_PASS_0_closure_L3_args);

  // RUNNETRWORK LAYER TestRQAdd1__MERGE_ADDRQ_PASS_0 CALL END
}
